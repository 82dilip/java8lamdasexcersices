...
// END findLongTracks_4
    ...
    public static void main(String[] args) {
		List<Album> albums= SampleData.getAlbum();
		Refactor.Step4 step1 = new Refactor.Step4();
		System.out.println(step1.findLongTracks(albums));
	}
}
