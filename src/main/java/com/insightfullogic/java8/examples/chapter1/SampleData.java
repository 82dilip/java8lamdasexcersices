...
public class SampleData {
    ...
    public static final Album manyTrackAlbum = new Album("sample Short Album", asList(new Track("short track", 30), new Track("short track 2", 30), new Track("short track 3", 80), new Track("short track 4", 30), new Track("short track 5", 30)), asList(johnColtrane));
